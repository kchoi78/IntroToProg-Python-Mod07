...
#   Kelly Choi, 2/27/2024, Edited script and added notes
# ------------------------------------------------------------------------------------------ #
import json
...
class Student(Person):  # * adding (Person) will inherit code from the Person class,
    ...
    # TODO add an assignment to the course_name property using the course_name parameter (Done above)
    ...
    #I didn't add any error validation because I feel like a course could in theory have any character
